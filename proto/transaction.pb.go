...
var file_proto_transaction_proto_rawDesc = []byte{
	...
	0x00, 0x12, 0x46, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
...
var file_proto_transaction_proto_depIdxs = []int32{
	...
	1, // 2: proto.Transaction.CreateUser:input_type -> proto.CreateUserRequest
	3, // 3: proto.Transaction.Transaction:input_type -> proto.TransactionRequest
	2, // 4: proto.Transaction.CreateUser:output_type -> proto.CreateUserResponse
	4, // 5: proto.Transaction.Transaction:output_type -> proto.TransactionResponse
